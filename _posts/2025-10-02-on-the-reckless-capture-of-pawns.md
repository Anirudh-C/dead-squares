...
[^7]: The *Weeping* **Gladiator** is named after the classical opening the Benoni defense, which is now called the old Benoni defense. Benoni or Ben-Oni which is a biblical name that translates to "son of my sorrow"fi; hence, the *Weeping* **Gladiator**. 
