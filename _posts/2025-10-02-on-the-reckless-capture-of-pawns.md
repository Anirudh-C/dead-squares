...
### Fortunate Sons
The **Fortunate Sons** appear in far more complicated mechanisms than **Gladiators** as they may occur after *any* move by white. Having learnt a valuable lesson from the perils of counting the number of variations that yield **Gladiators**, it seems appropriate to primarily discuss interesting **Fortunate Sons**. For the longest time, I used to feature a prominent **Fortunate Son** in my games, *il Calabrese*.
...
[^6]: TODO: a blog post on dishonourable gambits.
...
[^8]: Joseph Henry Blackburne was one of the first players to have used the Benoni defense with success. See his [game](https://www.chessgames.com/perl/chessgame?gid=1001636) against Preston Ware in the [Vienna Tournament in 1882](https://www.chessgames.com/perl/chess.pl?tid=80456).