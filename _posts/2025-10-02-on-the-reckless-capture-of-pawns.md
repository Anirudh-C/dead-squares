...
### footnotes
[^1]: I really liked that I could rhyme in that phrase although it seems like a bit of a stretch.
...
[^7]: The *Weeping* **Gladiator** is named after the classical opening the Benoni defense, which is now called the old Benoni defense. Benoni or Ben-Oniadd is a biblical name that translates to "son of my sorrow"; hence, the *Weeping* **Gladiator**. 
